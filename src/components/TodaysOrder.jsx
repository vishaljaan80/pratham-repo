...
const TodaysOrder = ({ data ,name}) => {
  return (
    <div className="flex gap-1 mt-2 mr-2">
      <div className="p-4 px-0 md:px-2 ml-5 bg-white overflow-x-auto rounded-lg">
        <h1 className="text-2xl text-[#101828d4]">{name}</h1>
        <div className="flex flex-wrap justify-center pt-5 gap-10 px-4  ">
          {data.map((item, index) => (
            <div key={index} className="flex flex-col items-center sm:px-10 px-4 text-center">
