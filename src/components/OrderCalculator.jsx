...
const OrderCalculator = ({name,head1,head2,user}) => {
  return (
    <div className="text-center lg:w-[26vw] w-[90%] sm:mb-0 mb-7 flex flex-col bg-white p-4 px-10 rounded-lg text-[#667085] gap-2 md:px-10 md:m-4">
      <h1 className="text-xl text-[#101828d4] font-semibold my-5">{name}</h1>
